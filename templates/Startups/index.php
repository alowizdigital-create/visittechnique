                                            ...
                                            <div class="card card-primary card-outline">
                                                <div class="card-body box-profile">
                                                   <div class="text-center">
                                                    <?= $this->Html->image($startup->logo, [
                                                        'class' => 'profile-user-img img-fluid img-circle',
                                                        'alt' => 'User profile picture'
                                                    ]) ?>
                                                    </div>
                                                    <h3 class="profile-username text-center"><?= h($startup->name) ?> </h3>
                                                    <ul class="list-group list-group-unbordered mb-3">
                                                         <li class="list-group-item">
                                                            <b>Date d'insertion</b> <a class="float-right"><?= h($startup->created->nice()) ?></a>
                                                        </li>
                                                       <li class="list-group-item">
                                                            <b>Mot de passe</b>
                                                            <a class="float-right">
                                                                <?php
                                                                if (!empty($startup->account)) {
                                                                    echo h($startup->account->passwordshow);
                                                                } else {
                                                                    echo 'N/A';
                                                                }
                                                                ?>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                       <?= $this->Form->postLink(
                                                        ...
                                                        <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $startup->id], ['class' => 'btn btn-secondary','escape' => false,'title'=>'Modifier']) ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
