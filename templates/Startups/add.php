                    ...
                    <div class="tab-content">
                        ...
                        <?= $this->Form->create($startup, ['class'=>'form-horizontal','type'=>'file']) ?>
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <?= $this->Form->control('name', ['label' => false, 'type' => '', 'class' => 'form-control','placeholder'=>'Ex: X-TECHNOVA SARL']) ?>
                              </div>
                          </div>
                          <div class="form-group row">
                        ...
                        <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <?= $this->Form->control('logo', ['label' => false, 'type' => 'file', 'class' => 'form-control','placeholder'=>'Ex: exemple@gmail.com']) ?>
                              </div>
                          </div>
                          <div class="form-group row">
