            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-sm">
                ...
                <tr>
                    ...
                    <!-- <td><?= h($vehicle->gender_id) ?></td> -->
                    <td class="actions">
                          <?= $this->Html->link(__('<i class="fas fa-eye" style="color:#000;"></i>'), ['action' => 'view', $vehicle->id], ['escape' => false, 'title'=>'Consulter']) ?>
