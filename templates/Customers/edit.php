...
<body class="hold-transition sidebar-mini">
    ...
    <section class="content-head">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="margin-left: 20px; margin-top: 20px;">  <i class="nav-icon fas fa-edit"></i> Modifier</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025 <a href="#">X-technova</a></strong> All rights reserved.
  </footer>
  <!-- Control Sidebar -->
