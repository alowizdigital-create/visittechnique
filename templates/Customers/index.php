            ...
            <div class="col-12" style="margin-top: 54px;">
              <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h3 class="card-title"><?= __('Listes des clients') ?></h3>
                  <div class="ml-auto">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td class="actions">
                              <?= $this->Html->link(__('<i class="fas fa-eye" style="color:#000;"></i>'), ['action' => 'view', $customer->id], ['escape' => false, 'title'=>'Consulter']) ?>
                              <?= $this->Html->link(__('<i class="fas fa-edit" style="color:#000;"></i>'), ['action' => 'edit', $customer->id], ['escape' => false,'title'=>'Modifier']) ?>
                            <?= $this->Form->postLink(
